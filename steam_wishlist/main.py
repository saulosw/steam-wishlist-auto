...
def login_steam(username, password):
    ...
    user_input = browser.find_element(By.CSS_SELECTOR, 'input[type="text"]._2GBWeup5cttgbTw8FM3tfx')
    user_input.send_keys(username)
    
    pass_input = browser.find_element(By.CSS_SELECTOR, 'input[type="password"]._2GBWeup5cttgbTw8FM3tfx')
...
def get_game_data(url):
    ...
    price_original_get = wishlist_game_page.find('div', class_='game_purchase_price price')
    ...
    return game_name, original_price
...
for url in wishlist_urls:
    ...
    values_data = (f'{page_data[0]} - Preço Original: {page_data[1]}')
